            ...
            Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Align(alignment: Alignment.centerLeft,child: Text("Liked by tracyamalone and 10 others", style: TextStyle(fontSize: 15.5),)),
                ),
                Padding(
                  padding: EdgeInsets.only(left: 16, top: 8),
                  child: Row(children: <Widget>[
                    Text("donnaq144", style: TextStyle(fontWeight: FontWeight.w600),),
                    SizedBox(width: 5,),
